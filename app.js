...
let content = {
  videos: [
    { title: 'The horror films that genuinely disturbed me', meta: 'Deep dive · 3 days ago', url: 'https://www.youtube.com/@lauraloveshorrors' },
    { title: '10 psychological horror films you need to see', meta: 'Recommendations · 1 week ago', url: 'https://www.youtube.com/@lauraloveshorrors' },
    { title: 'The most unsettling A24 films, ranked', meta: 'Ranking · 2 weeks ago', url: 'https://www.youtube.com/@lauraloveshorrors' }
  ],
  review: { title: 'The Last Stop in Yuma County', year: '2023', director: 'Francis Galluppi', genre: 'Neo-noir · Thriller', rating: '★★★★½', image: 'https://images.unsplash.com/photo-1517604931442-7e0c8ed2963c?auto=format&fit=crop&w=1000&q=85', copy: 'A wickedly controlled pressure-cooker that turns one empty desert diner into a sweat-soaked nightmare. Funny, mean and genuinely unpredictable.', url: 'reviews.html' },
  reviews: [
